...
class GetMotionType(smach.State):
    def __init__(self):
        smach.State.__init__(self, outcomes=["base_motion", "arm_motion", "no_motion"])

    def execute(self, userdata):
        base_motion_enabled = rospy.get_param("~base_motion_enabled", False)
        is_camera_static = rospy.get_param("~is_camera_static", False)
        if is_camera_static:
            return "no_motion"
        else:
...
def main():
    ...
    with sm:
        ...
        smach.StateMachine.add(
            "SETUP", Setup(), transitions={"succeeded": "MOVE_ARM_INIT"},
        )
        ...
        smach.StateMachine.add(
            ...
            transitions={
                "succeeded": "CHECK_IF_BASE_CENTERED",
                "failed": "CHECK_IF_BASE_CENTERED",
            },
        )
        ...
        smach.StateMachine.add(
            ...
            transitions={
                ...
                "no_motion": "START_OBJECT_RECOGNITION",
            },
        )
        ...
        smach.StateMachine.add(
            "CHECK_IF_STATIC_CAMERA",
            GetMotionType(),
            transitions={
                "base_motion": "GET_MOTION_TYPE",
                "arm_motion": "GET_MOTION_TYPE",
                "no_motion": "STOP_OBJECT_LIST_MERGER",
            },
        )
